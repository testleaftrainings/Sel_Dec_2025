...
2)click the checkbox of create a simple project
3)group id name--->company name(lowercase)
4)Artifactid--->project name(pascal case,note:it sholud not created with space or comma)

Datatype:
-whole number
 a)int-32bit(till 9 digits)
 b)long-64bit(more than 9digits)
 c)short-16bit(5digits)
 d)byte-8bit
 -decimal digits
  a)float--32bit(6 to7 digits)
  b)double-64bit(15digits)
-single character:
 char
